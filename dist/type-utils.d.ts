...
import type { ArrayOf, BasicDataType, ComplexDataType, Enum, EnumMember, OneOf, RecordOf, SetOf, TypeSchema } from "./types";
...
export declare type EnsureIsKey<K> = K extends "arrayOf" | "recordOf" | "setOf" | "oneOf" | "enumInstance" | "enumMember" ? K : "recordOf";
