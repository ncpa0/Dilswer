...
var validate_string_integer_exports = {};
__export(validate_string_integer_exports, {
  validateStringInteger: () => validateStringInteger
});
module.exports = __toCommonJS(validate_string_integer_exports);
